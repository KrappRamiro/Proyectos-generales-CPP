...
// puntero ++;
// puntero* = 'a';
// Esto depende de que tipo de variable es el puntero, si es un int avanza de a 4 bytes,
// si es un char avanza de a 1 byte
//
// Los tipos tienen que ser congruentes, si yo tengo un puntero int tengo que usarlo
// con un dato tipo int
//
// Se puede cambiar el tipo de una variable usando casteo
// si yo tengo int * puntero
// y char b
// tendria que hacer:
// puntero = (char*) &b
//
// Es mejor usar (*puntero) que usar *puntero
// (*datos).nombre 
// NO es lo mismo que
// *datos.nombre
//
// tambien esta el operador flechita ->
// datos -> nombre
// ES lo mismo que
// (*datos).nombre
//
// El nombre de un array es equivalente a un puntero a la primera posicion del array
}
